...
| Homebrew Etching PDF | `<name>_homebrew.pdf` | `export_homebrew_pdf` |
...
5. **Releases** tab — generate or auto-sync tag-based CD workflow YAML.
...
| `export_homebrew_pdf` | 1200 DPI homebrew etching & mask PDF | `'true'` |
